...
void readCCS811() {
  // Simulación de lectura del CCS811
  // Generamos valores aleatorios dentro de rangos típicos
  co2 = random(400, 1500);
  tvoc = random(0, 250);
  Serial.println("CCS811 (FAKE) - eCO2: " + String(co2) + " ppm, TVOC: " + String(tvoc) + " ppb");
  delay(10);
}